-- ============================================================================
-- IMPORT.SQL - Sistema Katalogon - Gestión de Inventarios
-- Compatible con MySQL 8.0+
-- SOLO INSERTS - Un INSERT por fila
-- ============================================================================

-- Desactivar verificación de foreign keys temporalmente para inserción
...
-- 4. ARTÍCULOS
-- ============================================================================
INSERT INTO articulos (codArticulo, descripcionArticulo, stockActual, stockSeguridad, demanda, costoAlmacenamiento, fechaHoraBaja, activo, loteOptimo, puntoPedido, tiempoIntervalo, cgi, proveedor_predeterminado_id, modelo_inventario_id) VALUES (1, 'Smartphone Samsung Galaxy A54', 45, 10.0, 360.0, 25.50, NULL, TRUE, 60.0, 35.0, NULL, 9825.75, 1, 1);
INSERT INTO articulos (codArticulo, descripcionArticulo, stockActual, stockSeguridad, demanda, costoAlmacenamiento, fechaHoraBaja, activo, loteOptimo, puntoPedido, tiempoIntervalo, cgi, proveedor_predeterminado_id, modelo_inventario_id) VALUES (2, 'Laptop HP Pavilion 15', 12, 5.0, 120.0, 180.00, NULL, TRUE, 20.0, 15.0, NULL, 24650.00, 2, 1);
INSERT INTO articulos (codArticulo, descripcionArticulo, stockActual, stockSeguridad, demanda, costoAlmacenamiento, fechaHoraBaja, activo, loteOptimo, puntoPedido, tiempoIntervalo, cgi, proveedor_predeterminado_id, modelo_inventario_id) VALUES (3, 'Tablet iPad Air 10.9', 8, 3.0, 96.0, 150.00, NULL, TRUE, 15.0, 10.0, NULL, 19875.50, 1, 1);
INSERT INTO articulos (codArticulo, descripcionArticulo, stockActual, stockSeguridad, demanda, costoAlmacenamiento, fechaHoraBaja, activo, loteOptimo, puntoPedido, tiempoIntervalo, cgi, proveedor_predeterminado_id, modelo_inventario_id) VALUES (4, 'Auriculares Sony WH-1000XM4', 25, 8.0, 200.0, 45.00, NULL, TRUE, 35.0, 20.0, NULL, 7150.25, 3, 1);
INSERT INTO articulos (codArticulo, descripcionArticulo, stockActual, stockSeguridad, demanda, costoAlmacenamiento, fechaHoraBaja, activo, loteOptimo, puntoPedido, tiempoIntervalo, cgi, proveedor_predeterminado_id, modelo_inventario_id) VALUES (5, 'Monitor LG 27 4K', 6, 2.0, 72.0, 120.00, NULL, TRUE, 12.0, 8.0, NULL, 15420.00, 2, 1);
INSERT INTO articulos (codArticulo, descripcionArticulo, stockActual, stockSeguridad, demanda, costoAlmacenamiento, fechaHoraBaja, activo, loteOptimo, puntoPedido, tiempoIntervalo, cgi, proveedor_predeterminado_id, modelo_inventario_id) VALUES (6, 'Mouse Logitech MX Master 3', 35, 12.0, 240.0, 15.75, NULL, TRUE, NULL, NULL, 30, 3680.50, 4, 2);
INSERT INTO articulos (codArticulo, descripcionArticulo, stockActual, stockSeguridad, demanda, costoAlmacenamiento, fechaHoraBaja, activo, loteOptimo, puntoPedido, tiempoIntervalo, cgi, proveedor_predeterminado_id, modelo_inventario_id) VALUES (7, 'Teclado Mecánico Corsair K95', 18, 6.0, 144.0, 35.25, NULL, TRUE, NULL, NULL, 45, 5950.75, 3, 2);
INSERT INTO articulos (codArticulo, descripcionArticulo, stockActual, stockSeguridad, demanda, costoAlmacenamiento, fechaHoraBaja, activo, loteOptimo, puntoPedido, tiempoIntervalo, cgi, proveedor_predeterminado_id, modelo_inventario_id) VALUES (8, 'Webcam Logitech C920', 22, 8.0, 180.0, 22.50, NULL, TRUE, NULL, NULL, 30, 4575.00, 4, 2);
INSERT INTO articulos (codArticulo, descripcionArticulo, stockActual, stockSeguridad, demanda, costoAlmacenamiento, fechaHoraBaja, activo, loteOptimo, puntoPedido, tiempoIntervalo, cgi, proveedor_predeterminado_id, modelo_inventario_id) VALUES (9, 'Disco SSD Samsung 1TB', 40, 15.0, 300.0, 65.00, NULL, TRUE, NULL, NULL, 60, 9125.25, 5, 2);
INSERT INTO articulos (codArticulo, descripcionArticulo, stockActual, stockSeguridad, demanda, costoAlmacenamiento, fechaHoraBaja, activo, loteOptimo, puntoPedido, tiempoIntervalo, cgi, proveedor_predeterminado_id, modelo_inventario_id) VALUES (10, 'Router WiFi TP-Link AX3000', 15, 5.0, 90.0, 85.00, NULL, TRUE, NULL, NULL, 90, 7650.50, 5, 2);

-- ============================================================================
-- 5. ARTÍCULO_PROVEEDOR (Relaciones Artículo-Proveedor)
-- ============================================================================
...
-- ============================================================================
-- 7. VENTA_ARTICULO (Detalle de ventas)
-- ============================================================================
...
-- ============================================================================
-- 9. ORDEN_COMPRA_ESTADO (Historial de estados)
-- ============================================================================
...
-- ============================================================================
-- 10. CONFIGURACIÓN GESTIÓN INVENTARIO
-- ============================================================================
